<div class="listej">
            <div><h3 class="entete">LISTE DES JOUEURS PAR SCORE</h3></div>
                ...
                echo '<table style="width: 300px; height: 40;position: absolute;top: 60px; font-size: 5mm;box-shadow: 0 0 0 1px #03b7ec;border-radius: 5px;text-align: justify;margin-left: 100px; border: 1px black; font-size: ;color:#818181;">';
                ...
                if ($pageActuelle>1) 
                {
                    ...
                    echo  '<a class="precedent" href="index.php?lien=accueil&page=liste-joueurs&liste='.$precedent.'" style="top: 500px;left: 20px;">Precedent</a>';
                }
                if ($pageActuelle<$nbredepage) 
                {
                    $Suivant = $pageActuelle+1;
                    echo  '<a class="suivant" href="index.php?lien=accueil&page=liste-joueurs&liste='.$Suivant.'" style="top: 500px;left: 380px;">Suivant</a>';
                }
                if($pageActuelle==$nbredepage) 
                {
                    $precedent = $pageActuelle-1;
